...
const uid = random()
// const drawIt = gsap.timeline({ repeat: -1 })
// onMounted(async () => {
//   const { DrawSVGPlugin } = await import('gsap/dist/DrawSVGPlugin')
//   gsap.registerPlugin(DrawSVGPlugin)
//   drawIt.from(`#${uid}-p01`, { drawSVG: 0, duration: 0.5 })
//   drawIt.from(`#${uid}-d02`, { opacity: 0, ease: 'power2.in', duration: 0.5 })
//   drawIt.from(`#${uid}-p02`, { drawSVG: 0, duration: 0.5 })
//   drawIt.from(`#${uid}-p03`, { drawSVG: 0, duration: 1 })
//   drawIt.from(`#${uid}-p04`, { drawSVG: 0, duration: 0.75 })
//   drawIt.from(`#${uid}-pd05`, { drawSVG: 0, duration: 0.5 })
//   drawIt.from(`#${uid}-p05`, { drawSVG: 0, duration: 0.5 })
//   drawIt.from(`#${uid}-p06`, { drawSVG: 0, duration: 0.5 })
//   drawIt.from(`#${uid}-p07`, { drawSVG: 0, duration: 0.75 })
//   drawIt.from(`#${uid}-p081`, { drawSVG: 0, duration: 0.5 })
//   drawIt.from(`#${uid}-p082`, { drawSVG: 0, duration: 0.25 })
//   drawIt.from(`#${uid}-p09`, { drawSVG: 0, duration: 0.5 })
